            ...
            <Box sx={{
                ...
                <List sx={{ listStyleType: 'disc', paddingLeft: '1em' }}>
                    <ListItem sx={{ display: 'list-item' }}>
                        <ListItemText
                            primary={
                                <Typography variant="body1" sx={{ fontSize: variant6font, marginBottom: '-20px' }}> {/* You can use other variants like body2, subtitle1, etc. */}
                                    Our team comprises proficient and devoted client managers who have undergone thorough account management training.
                                </Typography>
                            }
                        />
                    </ListItem>
                    <ListItem sx={{ display: 'list-item' }}>
                        <ListItemText
                            primary={
                                <Typography variant="body1" sx={{ fontSize: variant6font, marginBottom: '-20px' }}>
                                    They specialize in strategic sourcing and headhunting, ensuring alignment between candidate profiles and the specific requirements of client companies.
                                </Typography>
                            }
                        />
                    </ListItem>
                    <ListItem sx={{ display: 'list-item' }}>
                        <ListItemText
                            primary={
                                <Typography variant="body1" sx={{ fontSize: variant6font, marginBottom: '-20px' }}>
                                    Utilizing a distinctive automated resume management process, we efficiently cater to high-volume staffing needs.
                                </Typography>
                            }
                        />
                    </ListItem>
                    <ListItem sx={{ display: 'list-item' }}>
                        <ListItemText
                            primary={
                                <Typography variant="body1" sx={{ fontSize: variant6font, marginBottom: '-20px' }}>
                                    Employing a personalized reporting, metrics, and tracking system, we empower our clients by enhancing process efficiency and overall effectiveness.
                                </Typography>
                            }
                        />
                    </ListItem>
                    <ListItem sx={{ display: 'list-item' }}>
                        <ListItemText
                            primary={
                                <Typography variant="body1" sx={{ fontSize: variant6font, marginBottom: '-20px' }}>
                                    Our services and support structures are finely tuned to meet client needs, addressing placement precision, volume considerations, and the uncompromising quality of staffing.
                                </Typography>
                            }
                        />
                    </ListItem>
